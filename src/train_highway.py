#!/usr/bin/env python3
"""
Training script for PPO on Highway environment.
"""
...
def main():
    """Main training function for PPO on Highway."""
    parser = argparse.ArgumentParser(
        description="Train PPO agent on Highway environment"
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    trainer = PPOTrainer(
        contenous_decay=config.get("contenous_decay", 0.0),
        ...
        n_rollouts_per_update=config.get("n_rollouts_per_update", 10),
