...
def create_preference_weights_gif(
    ...
    speed_weights = preference_weights[:, 0]
    safety_weights = preference_weights[:, 1]
    ...
    for t in range(n_timesteps):
        ...
        ax.plot(t, speed_weights[t], "ro", markersize=12)
        ax.plot(t, safety_weights[t], "ro", markersize=12)
